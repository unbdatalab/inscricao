...
module.exports = async (req, res) => {
  ...
  const cols = 'created_at,status,categoria,nome,nome_social,usa_nome_social,cpf,data_nascimento,email,telefone,' +
               'instituicao,vinculo,cargo,cep,logradouro,numero,bairro,complemento,uf,municipio,ip_region,ip_city';
  ...
  ws['!cols'] = head.map((h, i) => ({ wch: (i === 8 || i === 10) ? 30 : (i === 3 ? 26 : (i === 14 ? 24 : 15)) }));
